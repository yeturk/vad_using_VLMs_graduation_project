...
\usepackage{lipsum}
\usepackage[T1]{fontenc} %% proper Turkish glyphs (ç ş ı ğ ü ö) in the Özet


% Important information
%% Make sure to enter all the info below
\title{Video Anomaly Detection in Production/Assembly Lines}
\author{Alper Kaan Güler, Yunus Emre Türk}
